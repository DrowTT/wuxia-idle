...
import { Backpack, CalendarCheck, Flame, Gem, RotateCw, Sparkles, Swords, TimerReset, Trophy } from '@lucide/vue'
import { canBreakThrough, canClaimDailyCheckIn, canPractice, DAILY_CHECK_IN_REWARD, formatCompactIntegerNumber, getInnerForceRate, getInnerForceRateBonus, getNextRealmId, getPracticeCost, getRealm, isPracticeComplete } from '../domain/game'
    ...
    <div class="page-main-column">
      ...
      <el-card class="panel cultivation-panel" shadow="never">
        ...
        <div class="cultivation-details">
          <div><small>内力吐纳速度</small><b>{{ getInnerForceRate(game.player) }} / 秒</b><em v-if="getInnerForceRateBonus(game.player)">心法增益 +{{ getInnerForceRateBonus(game.player) }} / 秒</em></div>
